            ...
            tests: [
                {
                    testKey: "CBC-6965",
                    comment:
                        'chrome,SCENARIO: desktop | Gallery | Social Share Buttons | Verify Facebook button functionality(custom facebook popup) on richverse.com | 202 | qa-automation-post-01,STEP 7: Check that the Stay up to date popup is closing,Error:element (".qa-fb-like-popup__close-icon") still not existing after 10000ms',
                    status: "FAIL",
                },
            ],
        };
